...
| :--- | :--- |
| `data/splits.csv` | Registre de répartition Train/Val/Test (Indispensable pour la reproductibilité). |
| `reports/eda.pdf` | (Optionnel) Rapport d'analyse exploratoire des données. |
